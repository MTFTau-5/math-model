...
input_filepath = "/home/mtftau-5/workplace/数模/输出文件/电站4最大发电量与辐照值比值.xlsx"
output_filepath = "/home/mtftau-5/workplace/数模/输出文件/电站4最大发电量与辐照值比值（最小二乘法拟合）.xlsx"
least_squares_fit(input_filepath, output_filepath, degree=3)
